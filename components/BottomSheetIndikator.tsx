...
const BottomSheetIndikator = ({ isVisible, onClose }) => {
  ...
  return (
    <View style={styles.BottomSheet}>
      ...
      <View style={[styles.BottomSheetMainContainer, { width: screenWidth, height: isLandscape ? screenHeight * 0.9 : screenHeight * 0.5 }]}>
        ...
        <Text style={styles.contentText}>Filter Berdasarkan Indikator</Text>
        ...
        >
          {cardButtons.map((label, index) => (
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate(label)} // Navigasi sesuai dengan nama layar
            >
...
export default BottomSheetIndikator;
