...
export type PasienDipindahkanType = {
  pasienDipindahkan?: string;
  pasienDipindahkan1?: string;
...
const PasienDipindahkan = ({
  pasienDipindahkan,
  pasienDipindahkan1,
  propTop,
}: PasienDipindahkanType) => {
  const pasienDipindahkanStyle = useMemo(() => {
    return {
  ...
  return (
    <View style={[styles.pasienDipindahkan, pasienDipindahkanStyle]}>
      <View style={styles.judul}>
        <Text style={[styles.pasienDipindahkan1, styles.judulChildPosition]}>
          {pasienDipindahkan}
        </Text>
      ...
      <View style={styles.subJudul}>
        ...
        <Text style={[styles.pasienDipindahkan2, styles.amountTypo]}>
          {pasienDipindahkan1}
        </Text>
      </View>
    </View>
...
export default PasienDipindahkan;
