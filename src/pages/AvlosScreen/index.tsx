...
const AVLOS = () => {
        ...
        const response = await fetch(
          'https://samratindikator.online/borlostoi/public/insert/get_monthly_stats_by_indicator',
          {
            ...
            body: new URLSearchParams({
              ...
              indicator: 'AVLOS', // Parameter ruangan
  ...
  return (
    <View style={styles.screenGuest}>
      ...
      <View style={[styles.standaravlos, styles.ketShadowBox]}>
              <Text style={styles.standarAvlos}>STANDAR AVLOS : 6 - 9 Hari</Text>
      </View>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.tableContainer}>
          {/* Rows */}
          {[
            {label: 'MUJAIR A :', value: mujairA, standard: '60-85%', icon: 'green', symbol: '%'},
            {label: 'MUJAIR B :', value: mujairB, standard: '6-9 Hari', icon: 'green', symbol: ' Hari'},
            {label: 'MUJAIR C :', value: mujairC, standard: '1-3 Hari', icon: 'red', symbol: ' Hari'},
            {label: 'NIKE :', value: nike, standard: '40-50 Kali', icon: 'green', symbol: ' Kali'},
            {label: 'PAYANGKA :', value: payangka, standard: '< 20 ‰', icon: 'red', symbol: ' ‰'},
            {label: 'NEONATI :', value: neonati, standard: '< 45 ‰', icon: 'red', symbol: ' ‰'},
            {label: 'BOMBOYA :', value: bomboya, standard: '40-50 Kali', icon: 'green', symbol: ' Kali'},
            {label: 'KARPER :', value: karper, standard: '< 20 ‰', icon: 'red', symbol: ' ‰'},
            {label: 'ICU :', value: icu, standard: '< 45 ‰', icon: 'red', symbol: ' ‰'},
          ].map((row, index) => {
