...
import {DatePickerr, RealTimeClock} from '../../../../components';
...
const EditMujairA = ({route}) => {
  ...
  const fetchJumlahBed = async () => {
    try {
      ...
      if (
        ...
        result['jumlah bed Mujair A'] !== undefined
      ) {
  ...
  //     const rawText = await response.text();
  //     console.log('Response raw text (fetchJumlahBed):', rawText);
  ...
  //       result['jumlah bed Mujair A'] !== undefined
  //     ) {
  //       const jumlah = parseInt(result['jumlah bed Mujair A'], 10);
  //       const jumlahValid = isNaN(jumlah) || jumlah < 0 ? 0 : jumlah;
  //       setJumlahTempatTidur(jumlahValid.toString());
  //     } else {
  //       setJumlahTempatTidur('0');
  //       Alert.alert('Error', 'Data jumlah tempat tidur tidak ditemukan.');
  //     }
  //   } catch (error) {
  //     console.error('Fetch error:', error.message);
  ...
  // const updateJumlahBed = async () => {
  //   try {
  //     console.log('JumlahTempatTidur sekarang:', jumlahTempatTidur);

  //     if (!jumlahTempatTidur || isNaN(jumlahTempatTidur.trim())) {
  //       Alert.alert(
  //         'Error',
  //         'Jumlah tempat tidur belum diisi atau tidak valid.',
  //       );
  //       return;
  //     }

  //     const jumlahBedNumber = parseInt(jumlahTempatTidur.trim(), 10);
  //     if (jumlahBedNumber < 0) {
  //       Alert.alert('Error', 'Jumlah tempat tidur tidak boleh negatif.');
  //       return;
  //     }
  ...
  //         body: new URLSearchParams({
  //           ruangan: titleRuangan,
  //           jumlah_bed: jumlahBedNumber.toString(),
  //         }).toString(),
  //       },
  //     );

  //     const rawText = await response.text();
  //     console.log('Response raw text (updateJumlahBed):', rawText);
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={{marginVertical: 4, marginBottom: 24}}>
          <DatePickerr
